function readURL(e) {
    if (e.files && e.files[0]) {
        ...
        (t.onload = function(e) {
            ...
            ga("send", "event", "changeBackground"), replaceBackgroundImage(t);
        }),
        t.readAsDataURL(e.files[0]);
    }
}

function downloadCanvas(e, t, n) {
    fabricCanvas.deactivateAll(), fabricCanvas.renderAll();
    var r = document.getElementById(t),
        i = r.toDataURL("image/jpg");
    uploadObject(r), (e.href = i), (e.download = n);
}

function dataUrlToBase64(e) {
    return e.replace(/^data:image\/(png|jpg);base64,/, "");
}

function uploadObject(e) {
    var t = dataUrlToBase64(e.toDataURL("image/jpg")),
        n = base64ToBlob(t, "image/jpg"),
        r = new FormData();
    r.append(
            "image",
            n,
            "golden-ratio-" + Math.random().toString(36).substring(7) + ".jpg"
        ),
        $.ajax({
            url: "images",
            type: "POST",
...
function replaceBackgroundImage(e) {
    fabricCanvas.getObjects()[0].setSrc(e);
    var t = new Image();
    (t.onload = function() {
        var e = fabricCanvas.getObjects()[0];
        e.scaleToWidth(fabricCanvas.getWidth()),
            fabricCanvas.centerObject(e),
            setTimeout(function() {
                fabricCanvas.renderAll(), uploadObject(e);
            }, 100);
    }),
    (t.src = e);
}

function uploadBase64Image(e) {
    $.ajax({
        type: "POST",
        url: "/images",
        data: { base64: e },
...
function base64ToBlob(e, t) {
    t = t || "";
    for (
        var n = 1024, r = window.atob(e), i = [], o = 0, a = r.length; o < a; o += n
    ) {
        for (
            var s = r.slice(o, o + n), u = new Array(s.length), l = 0; l < s.length; l++
        )
            u[l] = s.charCodeAt(l);
    ...
    function y(e, t, n, r, i) {
        for (
            var o, a, s, u, l, c, d, f = e.length, y = p(t), v = [], b = 0; b < f; b++
        )
            if ((a = e[b]) || 0 === a)
            ...
            if (
                (!de.leadingWhitespace &&
                    $e.test(a) &&
                    v.push(t.createTextNode($e.exec(a)[0])), !de.tbody)
            )
                for (
                    a =
                    "table" !== l || Ue.test(a) ?
    ...
    function A(e, t, n, r) {
        ...
        if (m || (d > 1 && "string" == typeof p && !de.checkClone && nt.test(p)))
            return e.each(function(i) {
                var o = e.eq(i);
                m && (t[0] = p.call(this, i, o.html())), A(o, t, n, r);
            });
        if (
            d &&
            ...
            for (s = pe.map(h(l, "script"), S), a = s.length; c < d; c++)
                (o = l),
                c !== f &&
                ((o = pe.clone(o, !0, !0)), a && pe.merge(s, h(o, "script"))),
                n.call(e[c], o, c);
            if (a)
                for (u = s[s.length - 1].ownerDocument, pe.map(s, T), c = 0; c < a; c++)
                    (o = s[c]),
                    Be.test(o.type || "") &&
    ...
    function D(e) {
        ...
        return (
            ...
            ((n = N(e, t)),
                ("none" !== n && n) ||
                ((st = (
                        st || pe("<iframe frameborder='0' width='0' height='0'/>")
    ...
    function _(e, t, n, r, i) {
        for (
            ...
            r ?
            ("content" === n && (a -= pe.css(e, "padding" + qe[o], !0, i)),
                "margin" !== n &&
                (a -= pe.css(e, "border" + qe[o] + "Width", !0, i))) :
            ((a += pe.css(e, "padding" + qe[o], !0, i)),
                "padding" !== n &&
                (a += pe.css(e, "border" + qe[o] + "Width", !0, i)));
        return a;
    }
    ...
    function B(e, t, n) {
        ...
        n.queue ||
            ...
            ((n.overflow = [f.overflow, f.overflowX, f.overflowY]),
                (l = pe.css(e, "display")),
                "inline" ===
                ("none" === l ? pe._data(e, "olddisplay") || D(e.nodeName) : l) &&
                "none" === pe.css(e, "float") &&
    ...
    pe.extend({
            ...
            inArray: function(e, t, n) {
                ...
                if (t) {
                    ...
                    for (
                        r = t.length, n = n ? (n < 0 ? Math.max(0, r + n) : n) : 0; n < r; n++
                    )
    ...
    var ve = (function(e) {
        function t(e, t, n, r) {
            ...
            if (
                ...
                return n;
            if (!r &&
                ((t ? t.ownerDocument || t : I) !== H && L(t), (t = t || H), R)
            ) {
                if (11 !== m && (l = ye.exec(e)))
                    if ((i = l[1])) {
                        if (9 === m) {
            ...
            var i = n.length > 0,
                ...
                a = function(r, a, s, u, l) {
                    var c,
                        ...
                        w = b.length;
                    for (
                        l && (j = a === H || a || l); h !== w && null != (c = b[h]); h++
                    ) {
                        if (o && c) {
                            for (
                                d = 0, a || c.ownerDocument === H || (L(c), (s = !R));
                                (f = e[d++]);
        ...
        try {
            Y.apply((G = Z.call(I.childNodes)), I.childNodes),
            ...
            return r !== H && 9 === r.nodeType && r.documentElement ?
                ((H = r),
                    ...
                    (w.getById = i(function(e) {
                        return (
                            (M.appendChild(e).id = F), !H.getElementsByName || !H.getElementsByName(F).length
                        );
                    })),
                    w.getById ?
                    ...
                    (i(function(e) {
                            ...
                            e.querySelectorAll("[msallowcapture^='']").length &&
                                ...
                                _.push("\\[" + ne + "*(?:value|" + te + ")"),
                                e.querySelectorAll("[id~=" + F + "-]").length || _.push("~="),
        ...
        return (
            ...
            (A = t.select = function(e, t, n, r) {
                ...
                if (((n = n || []), 1 === d.length)) {
                    ...
                    for (
                        i = pe.needsContext.test(e) ? 0 : o.length; i-- && ((a = o[i]), !C.relative[(s = a.type)]);
                ...
                return (
                    (l || E(e, d))(
                        r,
                        t, !R,
                        n, !t || (ve.test(e) && c(t.parentNode)) || t
                    ),
                    n
                );
            }),
    ...
    pe.fn.extend({
        ...
        is: function(e) {
            return !!r(
                this,
                "string" == typeof e && we.test(e) ? pe(e) : e || [], !1
            ).length;
        },
    });
    var Te,
            ...
            if (r[1]) {
                if (
                    ((t = t instanceof pe ? t[0] : t),
                        ...
                        Ce.test(r[1]) && pe.isPlainObject(t))
                )
                    for (r in t)
            ...
            closest: function(e, t) {
                for (
                    var n,
                        ...
                        i = this.length,
                        o = [],
                        a = we.test(e) || "string" != typeof e ? pe(e, t || this.context) : 0; r < i; r++
                )
    ...
    pe.extend({
        ...
        pe.fn.extend({
            ...
            promise: function(e, t) {
                ...
                for (
                    "string" != typeof e && ((t = e), (e = undefined)), e = e || "fx"; a--;
        ...
        trigger: function(t, n, r, i) {
            ...
            if (
                ...
                if (!i && !l.noBubble && !pe.isWindow(r)) {
                    for (
                        u = l.delegateType || p, Qe.test(u + p) || (s = s.parentNode); s; s = s.parentNode
                    )
                        f.push(s), (c = s);
                ...
                if (
                    ((t.type = p), !i &&
                        ...
                        (!l._default || !1 === l._default.apply(f.pop(), n)) &&
                        Le(r) &&
                        a &&
                        r[p] &&
                        !pe.isWindow(r))
                ...
                return (
                    ...
                    ((r = e.target.ownerDocument || re),
                        ...
                        (e.pageY =
                            ...
                            ((i && i.clientTop) || (n && n.clientTop) || 0))), !e.relatedTarget &&
                    a &&
    ...
    pe.each({
        ...
        pe.fn.extend({
            ...
            off: function(e, t, n) {
                ...
                return (
                    (!1 !== t && "function" != typeof t) || ((n = t), (t = undefined)), !1 === n && (n = b),
                    this.each(function() {
            ...
            cleanData: function(e, t) {
                for (
                    var n,
                        ...
                        u = pe.cache,
                        l = de.attributes,
                        c = pe.event.special; null != (n = e[a]); a++
                )
                    if ((t || Le(n)) && ((i = n[s]), (o = i && u[i]))) {
                        if (o.events)
                            for (r in o.events)
    ...
    pe.extend({
                    ...
                    if (
                        ((o = typeof n),
                            ...
                            ("number" === o &&
                                ...
                                (u[t] = "inherit"), !(a && "set" in a && (n = a.set(e, n, r)) === undefined)))
                    )
                        try {
                            u[t] = n;
                        } catch (e) {}
        ...
        pe.each(["height", "width"], function(e, t) {
            pe.cssHooks[t] = {
                get: function(e, n, r) {
                    if (n)
                        return vt.test(pe.css(e, "display")) && 0 === e.offsetWidth ?
                            dt(e, xt, function() {
                                return q(e, t, r);
                            }) :
                            q(e, t, r);
        ...
        pe.each({ margin: "", padding: "", border: "Width" }, function(e, t) {
            (pe.cssHooks[e + t] = {
                expand: function(n) {
                    for (
                        var r = 0, i = {}, o = "string" == typeof n ? n.split(" ") : [n]; r < 4; r++
                    )
    ...
    pe.fn.extend({
            val: function(e) {
                var t,
                    ...
                    if (i)
                        return (t =
                                pe.valHooks[i.type] || pe.valHooks[i.nodeName.toLowerCase()]) &&
                            "get" in t &&
        ...
        pe.extend({
            valHooks: {
                ...
                select: {
                    ...
                    set: function(e, t) {
                        for (
                            var n, r, i = e.options, o = pe.makeArray(t), a = i.length; a--;
                ...
                if (3 !== o && 8 !== o && 2 !== o)
                    return "undefined" == typeof e.getAttribute ?
                        ...
                        ((1 === o && pe.isXMLDoc(e)) ||
                            ((t = t.toLowerCase()),
                                (i =
                                    pe.attrHooks[t] || (pe.expr.match.bool.test(t) ? Lt : Dt))),
                            n !== undefined ?
                            null === n ?
                            ...
                            r :
                            ((r = pe.find.attr(e, t)), null == r ? undefined : r));
            },
            attrHooks: {
                type: {
                    set: function(e, t) {
        ...
        (Lt = {
            set: function(e, t, n) {
                return (!1 === t ?
                    pe.removeAttr(e, n) :
                    (_t && Rt) || !Mt.test(n) ?
                    e.setAttribute((!Rt && pe.propFix[n]) || n, n) :
            ...
            propHooks: {
                tabIndex: {
                    get: function(e) {
                        ...
                        return t ?
                            parseInt(t, 10) :
                            qt.test(e.nodeName) || (Ot.test(e.nodeName) && e.href) ?
                            0 :
                            -1;
                    },
                },
            ...
            toggleClass: function(e, t) {
                ...
                return "boolean" == typeof t && "string" === n ?
                    ...
                    this.each(function() {
                        var t, r, i, o;
                        if ("string" === n)
                            for (r = 0, i = pe(this), o = e.match(je) || [];
                                (t = o[r++]);)
    ...
    pe.extend({
            ...
            ajax: function(t, n) {
                        ...
                        ((x = 2),
                            ...
                            (f.ifModified &&
                                ((w = C.getResponseHeader("Last-Modified")),
                                    ...
                                    (w = C.getResponseHeader("etag")) && (pe.etag[a] = w)),
                                204 === t || "HEAD" === f.type ?
                                (S = "nocontent") :
                                304 === t ?
                                (S = "notmodified") :
                                ((S = b.state), (d = b.data), (v = b.error), (o = !v))) :
                            ((v = S), (!t && S) || ((S = "error"), t < 0 && (t = 0))),
                            (C.status = t),
                            (C.statusText = (n || S) + ""),
                            o ? m.resolveWith(p, [d, S, C]) : m.rejectWith(p, [C, S, v]),
                            C.statusCode(y),
                            (y = undefined),
                            l && h.trigger(o ? "ajaxSuccess" : "ajaxError", [C, f, o ? d : v]),
                            g.fireWith(p, [C, S]),
                            l &&
                    ...
                    C = {
                        ...
                        getResponseHeader: function(e) {
                            ...
                            if (2 === x) {
                                if (!d)
                                    for (d = {};
                                        (t = Xt.exec(s));) d[t[1].toLowerCase()] = t[2];
                                t = d[e.toLowerCase()];
                            }
                ...
                if (
                    ((m.promise(C).complete = g.add),
                        ...
                        (f.dataTypes = pe
                            ...
                            .match(je) || [""]),
                        null == f.crossDomain &&
                        ((i = Gt.exec(f.url.toLowerCase())),
                            (f.crossDomain = !(!i ||
                                (i[1] === en[1] &&
                                    i[2] === en[2] &&
                                    (i[3] || ("http:" === i[1] ? "80" : "443")) ===
                                    (en[3] || ("http:" === en[1] ? "80" : "443")))
                            ))),
                        f.data &&
                        f.processData &&
                ...
                l && 0 == pe.active++ && pe.event.trigger("ajaxStart"),
                    ...
                    f.hasContent ||
                    (f.data &&
                        ((a = f.url += (Bt.test(a) ? "&" : "?") + f.data), delete f.data), !1 === f.cache &&
                        (f.url = zt.test(a) ?
                            a.replace(zt, "$1_=" + It++) :
                            a + (Bt.test(a) ? "&" : "?") + "_=" + It++)),
                    f.ifModified &&
                ...
                if ((c = U(Kt, f, n, C))) {
                    if (((C.readyState = 1), l && h.trigger("ajaxSend", [C, f]), 2 === x))
                        return C;
                    f.async &&
                        f.timeout > 0 &&
        ...
        pe.each(["get", "post"], function(e, t) {
            pe[t] = function(e, n, r, i) {
                return (
                    pe.isFunction(n) && ((i = i || r), (r = n), (n = undefined)),
                    pe.ajax(
                        pe.extend({ url: e, type: t, dataType: i, data: n, success: r },
    ...
    pe.each(
        ...
        pe.fn.extend({
            ...
            offsetParent: function() {
                return this.map(function() {
                    for (
                        var e = this.offsetParent; e && !pe.nodeName(e, "html") && "static" === pe.css(e, "position");
        ...
        pe.each(["top", "left"], function(e, t) {
            pe.cssHooks[t] = L(de.pixelPosition, function(e, n) {
                if (n)
                    return (n = ht(e, t)), ct.test(n) ? pe(e).position()[t] + "px" : n;
            });
        }),
    ...
    return (
        (pe.noConflict = function(t) {
            return (
                e.$ === pe && (e.$ = hn), t && e.jQuery === pe && (e.jQuery = pn), pe
            );
        }),
        t || (e.jQuery = e.$ = pe),
        pe
...
function() {
            ...
            (function() {
                ...
                function() {
                    ...
                    (e.refreshCSRFTokens = function() {
                        var e, i;
                        if (((i = r()), (e = n()), null != i && null != e))
                            return t('form input[name="' + e + '"]').forEach(function(e) {
                                return (e.value = i);
                            });
                    });
                }.call(this),
                function() {
                    ...
                    "function" != typeof t &&
                        ...
                        (n = e.fire = function(e, n, r) {
                            var i;
                            return (
                                (i = new t(n, { bubbles: !0, cancelable: !0, detail: r })),
                                e.dispatchEvent(i), !i.defaultPrevented
                            );
                        }),
                        (e.stopEverything = function(e) {
                            return (
                    ...
                    (e.ajax = function(e) {
                        ...
                        return (
                            ...
                            (t = r(e, function() {
                                var n;
                                return (
                                    (n = a(t.response, t.getResponseHeader("Content-Type"))),
                                ...
                                if (e.name)
                                    return t(e, "select") ?
                                        n(e.options).forEach(function(t) {
                                            if (t.selected)
                                                return o.push({ name: e.name, value: t.value });
                                        }) :
                                        e.checked ||
                                        -1 === ["radio", "checkbox", "submit"].indexOf(e.type) ?
                                        o.push({ name: e.name, value: e.value }) :
                                        void 0;
                            }),
                            r && o.push(r),
                            o
                ...
                function() {
                    ...
                    (d = e.stopEverything),
                    (s = e.formElements),
                    (e.handleDisabledElement = function(e) {
                        var t;
                    ...
                    (e.enableElement = function(t) {
                        ...
                        return (
                            ...
                            l(n, e.linkDisableSelector) ?
                            a(n) :
                            l(n, e.buttonDisableSelector) || l(n, e.formEnableSelector) ?
                            i(n) :
                            l(n, e.formSubmitSelector) ?
                            o(n) :
                            void 0
                        );
                    }),
                    (e.disableElement = function(i) {
                        var o;
                        return (
                            (o = i instanceof Event ? i.target : i),
                            l(o, e.linkDisableSelector) ?
                            r(o) :
                            l(o, e.buttonDisableSelector) || l(o, e.formDisableSelector) ?
                            t(o) :
                            l(o, e.formSubmitSelector) ?
                            n(o) :
                            void 0
                        );
                    }),
                    (r = function(e) {
                        var t;
                        return (
                            (t = e.getAttribute("data-disable-with")),
                            null != t &&
                            (c(e, "ujs:enable-with", e.innerHTML), (e.innerHTML = t)),
                    ...
                    (a = function(e) {
                        var t;
                        return (
                            (t = u(e, "ujs:enable-with")),
                            null != t && ((e.innerHTML = t), c(e, "ujs:enable-with", null)),
                    ...
                    (t = function(e) {
                        ...
                        return (
                            ...
                            (l(e, "button") ?
                                (c(e, "ujs:enable-with", e.innerHTML), (e.innerHTML = t)) :
                                (c(e, "ujs:enable-with", e.value), (e.value = t))),
                            (e.disabled = !0),
                            c(e, "ujs:disabled", !0)
                        );
                    }),
                    ...
                    (i = function(e) {
                        ...
                        return (
                            (t = u(e, "ujs:enable-with")),
                            null != t &&
                            (l(e, "button") ? (e.innerHTML = t) : (e.value = t),
                ...
                function() {
                    ...
                    (e.handleMethod = function(n) {
                        var r, i, o, a, s, u, l;
                        if (((u = this), (l = u.getAttribute("data-method"))))
                            return (
                                (s = e.href(u)),
                                (i = e.csrfToken()),
                                (r = e.csrfParam()),
                ...
                function() {
                        ...
                        return (
                            ...
                            (n(m, "ajax:before") ?
                                ((v = m.getAttribute("data-with-credentials")),
                                    ...
                                    a(m, e.formSubmitSelector) ?
                                    ((f = r(m, "ujs:submit-button")),
                                        (g =
                                            r(m, "ujs:submit-button-formmethod") || m.method),
                                        (y =
                                            r(m, "ujs:submit-button-formaction") ||
                                        ...
                                        ((p = new FormData(m)),
                                            null != f && p.append(f.name, f.value)) :
                                        (p = s(m, f)),
                                        u(m, "ujs:submit-button", null),
                                        u(m, "ujs:submit-button-formmethod", null),
                                        u(m, "ujs:submit-button-formaction", null)) :
                                    a(m, e.buttonClickSelector) ||
                                    a(m, e.inputChangeSelector) ?
                    ...
                    (e.formSubmitButtonClick = function() {
                        ...
                        if (((e = this), (t = e.form)))
                            return (
                                e.name &&
                                u(t, "ujs:submit-button", { name: e.name, value: e.value }),
                ...
                function() {
                    var t, n, r, i, o, a, s, u, l, c, d, f, p, h;
                    (a = e.fire),
                    (r = e.delegate),
                    (u = e.getData),
                    (t = e.$),
                        ...
                        (e.start = function() {
                            ...
                            return (
                                window.addEventListener("pageshow", function() {
                                    return (
                                        t(e.formEnableSelector).forEach(function(e) {
                                            if (u(e, "ujs:disabled")) return o(e);
                                        }),
                                        t(e.linkDisableSelector).forEach(function(e) {
                                            if (u(e, "ujs:disabled")) return o(e);
                                        })
                                    );
                                }),
                                ...
                                r(document, e.buttonClickSelector, "click", p),
                                r(document, e.inputChangeSelector, "change", c),
                                r(document, e.inputChangeSelector, "change", l),
                                r(document, e.inputChangeSelector, "change", p),
                                r(document, e.formSubmitSelector, "submit", c),
                                r(document, e.formSubmitSelector, "submit", l),
                                r(document, e.formSubmitSelector, "submit", p),
                                r(document, e.formSubmitSelector, "submit", function(e) {
        ...
        (function() {
                (function() {
                        ...
                        e.ConnectionMonitor = (function() {
                            ...
                            return (
                                ...
                                (n.prototype.getPollInterval = function() {
                                    var e, t, n, i;
                                    return (
                                        (i = this.constructor.pollInterval),
                                        (n = i.min),
                                        (t = i.max),
                                ...
                                (n.prototype.connectionIsStale = function() {
                                    var e;
                                    return (
                                        o(null != (e = this.pingedAt) ? e : this.startedAt) >
                                        this.constructor.staleThreshold
                                    );
                                }),
                    ...
                    function() {
                        ...
                        (r = i.protocols),
                        (o =
                            2 <= r.length ? a.call(r, 0, (t = r.length - 1)) : ((t = 0), [])),
                        r[t++],
                            (e.Connection = (function() {
                                ...
                                return (
                                    ...
                                    (t.prototype.isProtocolSupported = function() {
                                        var e;
                                        return (e = this.getProtocol()), u.call(o, e) >= 0;
                                    }),
                                    ...
                                    (t.prototype.getState = function() {
                                        ...
                                        for (t in WebSocket)
                                            if (
                                                WebSocket[t] ===
                                                (null != (e = this.webSocket) ? e.readyState : void 0)
                                            )
                                        ...
                                        open: function() {
                                            if (
                                                (e.log(
                                                    ...
                                                    (this.disconnected = !1), !this.isProtocolSupported())
                                            )
                                                return (
                                                    e.log(
                        ...
                        e.Subscriptions = (function() {
                            ...
                            return (
                                ...
                                (n.prototype.reject = function(e) {
                                    var t, n, r, i, o;
                                    for (
                                        r = this.findAll(e), i = [], t = 0, n = r.length; t < n; t++
                                    )
                                        (o = r[t]),
                                        this.forget(o),
                                ...
                                (n.prototype.forget = function(e) {
                                    ...
                                    return (
                                        (this.subscriptions = function() {
                                            var n, r, i, o;
                                            for (
                                                i = this.subscriptions, o = [], n = 0, r = i.length; n < r; n++
                                            )
                                                (t = i[n]) !== e && o.push(t);
                                            return o;
                                        }.call(this)),
                                ...
                                (n.prototype.findAll = function(e) {
                                    var t, n, r, i, o;
                                    for (
                                        r = this.subscriptions, i = [], t = 0, n = r.length; t < n; t++
                                    )
                                        (o = r[t]), o.identifier === e && i.push(o);
                                    return i;
                                }),
                                (n.prototype.reload = function() {
                                    var e, t, n, r, i;
                                    for (
                                        n = this.subscriptions, r = [], e = 0, t = n.length; e < t; e++
                                    )
                                        (i = n[e]), r.push(this.sendCommand(i, "subscribe"));
                                    return r;
                                }),
                                (n.prototype.notifyAll = function() {
                                    ...
                                    for (
                                        ...
                                        (s = o[r]),
                                        a.push(this.notify.apply(this, [s, n].concat(t.call(e))));
                                    return a;
                                }),
                                (n.prototype.notify = function() {
                                    ...
                                    for (
                                        ...
                                        (a = s[r]),
                                        o.push(
                                            "function" == typeof a[n] ? a[n].apply(a, e) : void 0
                                        );
                                    return o;
                                }),
    ...
    $(function() {
        $("#valueSum").on("input", function() {
                const e = parseFloat($("#valueSum").val());
                isNaN(e) || ($("#valueA").val(0.382 * e), $("#valueB").val(0.618 * e));
            }),
            $("#valueA").on("input", function() {
                const e = parseFloat($("#valueA").val());
                if (!isNaN(e)) {
                    const t = 1.618 * e;
                    $("#valueB").val(t), $("#valueSum").val((e + t).toFixed(3));
                }
            }),
            $("#valueB").on("input", function() {
                const e = parseFloat($("#valueB").val());
                if (!isNaN(e)) {
                    const t = e / 1.618;
                    $("#valueA").val(t), $("#valueSum").val((t + e).toFixed(3));
                }
            });
    }),
    $(function() {
        -1 != navigator.userAgent.indexOf("Mac OS X") &&
            $(".paste-key").text("CMD");
        var e = (window.fabricCanvas = new fabric.Canvas("mainCanvas", {
            preserveObjectStacking: !0,
        }));
        !Cookies.get("has-moved-spiral") ?
            e.on("object:moving", function() {
                Cookies.set("has-moved-spiral", "true"), $(".start-hint").fadeOut();
            }) :
            $(".start-hint").hide(),
            fabric.Image.fromURL("images/golden-spiral.png", function(t) {
                t
                    .scale(0.21)
                    .set({
                        left: 62,
            ...
            fabric.Image.fromURL("images/donald.jpg", function(t) {
                t.scale(0.65).set({}), e.add(t), e.sendToBack(t);
            });
    }),
    $(function() {
        $("#image_upload").change(function() {
            ...
            document.getElementById("download_link").addEventListener("click", function() {
                ga("send", "event", "downloadImage"),
                    downloadCanvas(this, "mainCanvas", "golden-ratio.png")
            }, !1),
            document.getElementById("flip").addEventListener("click", function() {
                var e = window.flipped;
                window.flipped = !e,
                    fabricCanvas.getObjects()[1].set("flipX", window.flipped),
                    fabricCanvas.renderAll()
            }, !1),
            document.getElementById("invertColor").addEventListener("click", function() {
                var e = fabricCanvas.getObjects()[1];
                0 == e.filters.length ? e.filters[0] = new fabric.Image.filters.Invert : e.filters = [],
                    e.applyFilters(fabricCanvas.renderAll.bind(fabricCanvas))
            }, !1),
            document.getElementById("save").addEventListener("click", function() {
                fabricCanvas.deactivateAll(),
                    fabricCanvas.renderAll();
                var e = $("canvas")[0].toDataURL("image/jpg"),
                    t = e.replace(/^data:image\/(png|jpg);base64,/, ""),
                    n = base64ToBlob(t, "image/jpg"),
                    r = new FormData;
                r.append("image", n, "golden-ratio-" + Math.random().toString(36).substring(7) + ".jpg"),
                    $("#save").text("Saving ..."),
                    $.ajax({
                        url: "images",
                        type: "POST",
                        ...
                        var t = e.sha,
                            n = location.href + "images/" + t;
                        $("#save").text("Saved!"),
                            $(".share-link-msg").hide(),
                            $("#share_url").css("display", "inline-block"),
                            $("#share_url").attr("href", n),
                            $("#share_url").attr("target", "_blank"),
                            $("#share_url").text(n)
                    }).fail(function() {
                        $("#save").text("Save!"),
                            alert("Uploading failed. Please contact me at twitter.com/matixmatix")
                    })
            }, !1)
    }),
    $(function() {
        function e(e) {
            ...
            document.addEventListener(
                ...
                (this.init = (function() {
                    ...
                    t.setAttribute("id", "paste_ff"),
                        t.setAttribute("contenteditable", ""),
                        (t.style.cssText = "opacity:0;position:fixed;top:0px;left:0px;"),
                        (t.style.marginLeft = "-20px"),
                        (t.style.width = "10px"),
                        document.body.appendChild(t),
                        document.getElementById("paste_ff").addEventListener(
                            "DOMSubtreeModified",
                            function() {
                                if ("auto" == n || 0 == i) return !0;
                                1 == t.children.length &&
                                    t.firstElementChild.src != undefined &&
                                    r.paste_createImage(t.firstElementChild.src),
                                    setTimeout(function() {
                                        t.innerHTML = "";
                                    }, 20);
                            }, !1
                ...
                (this.on_keyboard_action = function(e) {
                    if (
                        ((k = e.keyCode),
                            (17 == k || e.metaKey || e.ctrlKey) && 0 == i && (i = !0),
                            86 == k)
                    ) {
                        if (
                            ...
                            return !1;
                        1 != i || window.Clipboard || t.focus();
                    }
                }),
                (this.on_keyboardup_action = function(e) {
                    (k = e.keyCode),
                    (17 == k || e.metaKey || e.ctrlKey || "Meta" == e.key) && (i = !1);
                }),
                (this.paste_createImage = function(e) {
                    replaceBackgroundImage(e);
                });
        }
        new e("mainCanvas", !0);
    });